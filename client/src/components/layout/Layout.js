...
const NAV_ITEMS = {
  ...
  owner: [
    ...
    { to: '/tasks-pipeline', icon: '📋', label: 'Tasks Pipeline', feature: 'canUseContentCalendar' },
  ...
  employee: [
    ...
    { to: '/pipeline', icon: '🔄', label: 'Leads Pipeline', userFeature: 'canAccessLeads' },
    { to: '/tasks-pipeline', icon: '📋', label: 'Tasks Pipeline', feature: 'canUseContentCalendar', userFeature: 'canUseContentCalendar' },
        ...
        <div className="sidebar-logo">
          ...
          {(!collapsed || mobileOpen) && (
            <div className="logo-text-wrap">
              ...
              <span className="logo-sub">Bixian CRM</span>
            </div>
          )}
        </div>
