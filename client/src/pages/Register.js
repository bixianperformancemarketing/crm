...
const s = {
  ...
  nav: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 32px', borderBottom: '1px solid #1e1e3a' },
  ...
  wrap: { display: 'flex', justifyContent: 'center', padding: '40px 20px 60px' },
  container: { width: '100%', maxWidth: 640, background: '#12121f', border: '1px solid #1e1e3a', borderRadius: 16, padding: '36px 32px' },
  ...
  planGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: 10 },
